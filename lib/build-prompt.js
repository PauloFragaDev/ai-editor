...
function buildSourceEditPrompt(e) {
  ...
  lines.push('');
  lines.push('PASO OBLIGATORIO ANTES DE EDITAR:');
  lines.push('Usa Read para leer el archivo que vas a editar, luego imprime su contenido COMPLETO entre estas marcas exactas:');
  lines.push('<<<BACKUP_START>>>');
  lines.push('[contenido íntegro del archivo, sin modificar]');
  lines.push('<<<BACKUP_END>>>');
  lines.push('Después aplica la edición con Edit.');
  lines.push('');
